...
// notesConstants.js
export const MARK_NOTE_AS_COMPLETED_REQUEST = 'MARK_NOTE_AS_COMPLETED_REQUEST';
export const MARK_NOTE_AS_COMPLETED_SUCCESS = 'MARK_NOTE_AS_COMPLETED_SUCCESS';
export const MARK_NOTE_AS_COMPLETED_FAIL = 'MARK_NOTE_AS_COMPLETED_FAIL';

...
export const markNoteAsCompletedReducer = (state = {}, action) => {
  switch (action.type) {
    case MARK_NOTE_AS_COMPLETED_REQUEST:
      return { loading: true };
    case MARK_NOTE_AS_COMPLETED_SUCCESS:
      return { loading: false, success: true };
    case MARK_NOTE_AS_COMPLETED_FAIL:
      return { loading: false, error: action.payload };
    default:
      return state;
  }
